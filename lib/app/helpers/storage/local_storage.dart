...
class LocalStorage {
  ...
  static Future<bool> setUserEmailSignInLink(String emailLink) {
    return preferences.setString("email_link", emailLink);
  }

  static String? getUserEmailSignInLink() {
    return preferences.getString("email_link");
  }
