...
import 'package:superfoods/app/helpers/widgets/my.dart';
import 'package:superfoods/app/helpers/widgets/my_breadcrumb_item.dart';
import 'package:superfoods/app/helpers/widgets/my_constant.dart';
...
class AppTheme {
  ...
  static Color primaryColor = Color.fromRGBO(34, 73, 19, 1);
    ...
    My.setConstant(
      MyConstantData(
        ...
        defaultBreadCrumbItem:
            MyBreadcrumbItem(name: 'Estates', route: '/all-projects'),
      ),
    );
    bool isMobile = true;
    try {
