...
class LeftBarTheme {
  ...
  final Color disabledBackground, disabledOnBackground;
  ...
  LeftBarTheme({
    ...
    this.disabledBackground = const Color.fromARGB(113, 49, 58, 70),
    this.disabledOnBackground = const Color(0xff98a6ad),
  ...
  static final LeftBarTheme darkLeftBarTheme = LeftBarTheme(
    ...
    disabledBackground: const Color(0xff444d57),
    disabledOnBackground: const Color(0xff515a65),
  );
...
class ContentTheme {
  ...
  ContentTheme({
    ...
    this.primary = const Color.fromRGBO(34, 73, 19, 1),
    // this.primary = const Color(0xFFFCFDFD),
