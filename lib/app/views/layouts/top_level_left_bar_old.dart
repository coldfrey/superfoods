...
import 'package:superfoods/app/helpers/services/url_service.dart';
...
class TopLevelLeftBar extends StatefulWidget {
  final bool isCondensed;

  const TopLevelLeftBar({super.key, this.isCondensed = false});

  @override
  _TopLevelLeftBarState createState() => _TopLevelLeftBarState();
}

class _TopLevelLeftBarState extends State<TopLevelLeftBar>
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    //   ],
                    // ),
                    LabelWidget(label: 'management'.tr()),
                    MenuWidget(
